...
It is not efficient only to learn algorithms but not to use. As time passes by, presumably I will forget them. Thus, I am adopting algorithms and data structure when I am faced with problems; all the examples are collected in the directory: [algorithms-examples](./Examples-of-Algorithms).